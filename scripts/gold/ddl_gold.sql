...
Script Purpose:
    ...
    The Gold layer represents the final dimension and fcat tables (Star Schema).
...
pr.product_key,  --surrogate/dimension key from gold_customer table
cu.customer_key,   --surrogate/dimension key from gold_product table
sd.sls_order_dt AS order_date,
sd.sls_ship_dt  AS shipping_date,
sd.sls_due_dt AS due_date,
sd.sls_sales AS sales_amount,
sd.sls_quantity AS quantity,
sd.sls_pricwe AS price
